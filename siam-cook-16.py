...
#             break
    ...
    tarCom = bert_emb.view(batch_size, max_length, d_model).clone()
    generated_words = generated_words.permute(1,0,2)
    loss_com_dtw = criterion(generated_words, tarCom)
...
#         torch.save(cnn1, "./cnn1_siam_rev_lowLR_random2.pth")
        torch.save(w_hidden2hidden.state_dict(), "./models/w_hidden2hidden_siam16_dict.pth")
        torch.save(boardenc2skill1.state_dict(), "./models/boardenc2skill1_siam16_dict.pth")
        ...
        torch.save(decoderBoard2.state_dict(), "./models/decoderBoard2_siam16_dict.pth")
#         torch.save(w_hidden2board, "./w_hidden2board_siam_rev_lowLR_random2.pth")
        torch.save(decoderComment.state_dict(), "./models/decoderComment_siam16_dict.pth")
        torch.save(comment2skill.state_dict(), "./models/comment2skill_siam16_dict.pth")
...
dataload = DataLoader(train_data, batch_size=200, num_workers=32, pin_memory=False)
print('Data loaded')
...
decoderComment = BoardEncodedtoSkills(1, 11, d_model, d_model)#DecoderRNNComment(d_model, train_data.n_words, n_layers=1)
